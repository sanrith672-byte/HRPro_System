  ...
  try {
    ...
    contentArea().innerHTML =
      ...
      +'<tr style="position:sticky;top:0;z-index:4;background:var(--bg2);height:26px">'
          ...
          +'<th style="width:'+(isMobile?28:32)+'px;text-align:center;font-size:9px;padding:3px 2px;color:#6366f1;position:sticky;right:'+(isMobile?28:32)+'px;z-index:5;background:var(--bg2);border-left:1px solid var(--border)" rowspan="2" title="OFF ខែ">📅OFF<br/><span style="font-size:8px;color:var(--text3)">ខែ</span></th>'
