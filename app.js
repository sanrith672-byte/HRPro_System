  ...
  try {
    ...
    contentArea().innerHTML =
      ...
      +'<tr style="position:sticky;top:0;z-index:4;background:var(--bg2);height:26px">'
          ...
          +'<th style="width:'+(isMobile?28:32)+'px;max-width:'+(isMobile?28:32)+'px;overflow:hidden;text-align:center;font-size:8px;padding:2px 0;color:#6366f1;position:sticky;right:'+(isMobile?28:32)+'px;z-index:5;background:var(--bg2);border-left:1px solid var(--border)" rowspan="2" title="📅 OFF ខែ"><span style="display:block;font-size:10px;font-weight:700;line-height:1.4">OFF</span><span style="display:block;font-size:9px;line-height:1.2;color:var(--text3)">ខែ</span></th>'
