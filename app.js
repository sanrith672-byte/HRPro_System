  ...
  try {
    ...
    const dayRows = filteredSummaries.map(({emp, present, late, absent, swap, overAbsent, deduction, offBonus, offDaysWorked, empOffDaysThisMonth}) => {
      ...
      return '<tr>'
        ...
        +'<td style="text-align:center;font-weight:700;font-size:12px;color:'+(empOffDaysThisMonth>0?'#6366f1':'var(--text3)')+';width:44px;padding:3px 2px;border-left:1px solid var(--border)" title="ថ្ងៃ OFF សរុបក្នុងខែ">'+(empOffDaysThisMonth>0?'<span style="background:rgba(99,102,241,.12);border-radius:4px;padding:1px 5px">'+empOffDaysThisMonth+'</span>':'—')+'</td>'
        +cells
    ...
    contentArea().innerHTML =
      ...
      +(window.innerWidth<700
        ...
        : '<tr style="position:sticky;top:0;z-index:4;background:var(--bg2);height:28px">'
          ...
          +'<th style="width:44px;text-align:center;font-size:10px;padding:3px 2px;color:#6366f1;border-left:1px solid var(--border)" rowspan="2" title="ថ្ងៃ OFF សរុបក្នុងខែ (ថ្ងៃឈប់ប្រចាំខែរបស់បុគ្គលិក)"><div style="display:flex;flex-direction:column;align-items:center;justify-content:center;gap:1px">📅 <span style="font-size:8px;font-weight:700">OFF</span><span style="font-size:8px;color:var(--text3)">ខែនេះ</span></div></th>'
          +dayThs
          +'<th style="width:36px;text-align:center;padding:3px 2px;font-size:10px;color:var(--success);position:sticky;right:68px;z-index:5;background:var(--bg2);box-shadow:-2px 0 4px rgba(0,0,0,.1)" rowspan="2" title="ថ្ងៃធ្វើការសរុប"><div style="display:flex;flex-direction:column;align-items:center;justify-content:center">📅<span style="font-size:7px;color:var(--text3)">សកម្ម</span></div></th>'+'<th style="width:64px;text-align:center;padding:3px 4px;position:sticky;right:0;z-index:5;background:var(--bg2);box-shadow:-2px 0 5px rgba(0,0,0,.15)" rowspan="2"><div style="display:flex;align-items:center;justify-content:center">📅 សកម្ម</div></th>'
          +'</tr>'
      ...
      +(()=>{
        ...
        if (mob) {
          return '<tfoot><tr style="position:sticky;bottom:0;z-index:3;background:var(--bg3);border-top:2px solid var(--border)">'
            ...
            +'<div style="color:var(--success)">✅ ធ្វើការ</div><div style="color:var(--danger)">🔴 Off</div><div style="color:#d97706;font-size:9px">🌟 OFF</div>'
        ...
        return '<tfoot><tr style="position:sticky;bottom:0;z-index:3;background:var(--bg3);border-top:2px solid var(--border)">'
          ...
          +'</td>'
          +'<td colspan="6" style="position:sticky;left:160px;z-index:4;background:var(--bg3);padding:4px 2px;text-align:center;font-size:10px">'
          +'<div style="color:var(--text3);line-height:1.5">'+totalEmps+' នាក់</div>'
          +'<div style="color:var(--text3);line-height:1.5">សរុប</div>'
          +'</td>'
          +(renderTotals.ob>0
            ?'<td style="position:sticky;left:368px;z-index:4;background:rgba(251,191,36,.12);box-shadow:3px 0 6px rgba(0,0,0,.12);padding:4px 2px;text-align:center;font-weight:700;color:#d97706;font-size:12px" title="🌟 OFF Bonus សរុប">+$'+renderTotals.ob.toFixed(0)+'</td>'
...
function printMonthlyAttendance() {
  ...
  const bodyRows = summaries.map(({emp, present, late, absent, swap, onLeave, overAbsent, deduction, offBonus}, idx) => {
    const empOff = parseOffDays(emp);
...
async function exportMonthlyAttendanceExcel() {
  ...
  try {
    ...
    const matrixHeaders = ['#', 'ឈ្មោះបុគ្គលិក', 'នាយកដ្ឋាន', '✅ វត្តមាន', '⏰ យឺត', '❌ អវត្តមាន', '🔄 ជំនួស', '🌴 ច្បាប់', 'លើសថ្ងៃ', 'កាត់ ($)', '🌟 OFF Bonus ($)', ...dayLabels];
