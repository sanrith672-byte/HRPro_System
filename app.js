  ...
  try {
    ...
    const dayRows = filteredSummaries.map(({emp, present, late, absent, swap, overAbsent, deduction, offBonus, offDaysWorked, empOffDaysThisMonth, workingDaysCount}) => {
      ...
      return '<tr>'
        ...
        +cells
        +'<td style="text-align:center;font-weight:700;font-size:12px;color:var(--success);width:'+(isMobile?28:32)+'px;padding:3px 2px;position:sticky;right:'+(isMobile?58:68)+'px;z-index:1;background:var(--bg2);box-shadow:-2px 0 4px rgba(0,0,0,.08)">'+(present+late)+'<span style="font-size:8px;font-weight:400;color:var(--text3);display:block">ថ្ងៃ</span></td>'
        +'<td style="text-align:center;font-weight:700;font-size:'+(isMobile?'11px':'12px')+';color:'+(empOffDaysThisMonth>0?'#6366f1':'var(--text3)')+';width:'+(isMobile?28:32)+'px;padding:3px 2px;position:sticky;right:'+(isMobile?30:36)+'px;z-index:1;background:var(--bg2);border-left:1px solid var(--border)">'+(empOffDaysThisMonth>0?'<span style="background:rgba(99,102,241,.12);border-radius:4px;padding:1px 4px">'+empOffDaysThisMonth+'</span>':'—')+'</td>'
        +'<td style="text-align:center;width:'+(isMobile?30:36)+'px;position:sticky;right:0;z-index:1;background:var(--bg2);box-shadow:-2px 0 5px rgba(0,0,0,.12)"><button class="btn btn-outline btn-sm" style="font-size:'+(isMobile?'9px':'10px')+';padding:2px '+(isMobile?'2px':'8px')+'" onclick="applyAbsenceDeduction('+emp.id+',\''+emp.name+'\','+absent+','+overAbsent+','+deduction+',\''+currentMonth+'\','+offBonus+')">💸</button></td>'
        +'</tr>';
    }).join('');
    ...
    contentArea().innerHTML =
      ...
      +'<tr style="position:sticky;top:0;z-index:4;background:var(--bg2);height:26px">'
          ...
          +dayThs
          +'<th style="width:'+(isMobile?28:32)+'px;text-align:center;padding:3px 2px;font-size:9px;color:var(--success);position:sticky;right:'+(isMobile?58:68)+'px;z-index:5;background:var(--bg2);box-shadow:-2px 0 4px rgba(0,0,0,.1)" rowspan="2" title="ធ្វើការ">📅<br/><span style="font-size:8px">ធ្វើ</span></th>'
          +'<th style="width:'+(isMobile?28:32)+'px;text-align:center;font-size:9px;padding:3px 2px;color:#6366f1;position:sticky;right:'+(isMobile?30:36)+'px;z-index:5;background:var(--bg2);border-left:1px solid var(--border)" rowspan="2" title="OFF ខែ">📅OFF<br/><span style="font-size:8px;color:var(--text3)">ខែ</span></th>'
      ...
      +(()=>{
        ...
        return '<tfoot><tr style="position:sticky;bottom:0;z-index:3;background:var(--bg3);border-top:2px solid var(--border)">'
          ...
          +(()=>{
            ...
            return '<td style="background:var(--bg3);position:sticky;right:'+(isMobile?58:68)+'px;z-index:4;width:'+(isMobile?28:32)+'px;text-align:center;padding:2px 1px;border-left:1px solid var(--border)">'
              ...
              +'</td>'
              +'<td style="background:var(--bg3);position:sticky;right:'+(isMobile?30:36)+'px;z-index:4;width:'+(isMobile?28:32)+'px;text-align:center;padding:2px 1px;border-left:1px solid var(--border)">'
