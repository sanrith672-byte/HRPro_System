  ...
  try {
    ...
    const dayRows = filteredSummaries.map(({emp, present, late, absent, swap, overAbsent, deduction, offBonus, offDaysWorked, empOffDaysThisMonth, workingDaysCount}) => {
      ...
      return '<tr>'
        ...
        +cells
        +'<td style="text-align:center;font-weight:700;font-size:11px;color:var(--success);width:'+(isMobile?30:34)+'px;padding:2px 1px;position:sticky;right:'+(isMobile?60:68)+'px;z-index:1;background:var(--bg2);box-shadow:-2px 0 4px rgba(0,0,0,.08)">'+(present+late)+'<span style="font-size:7px;font-weight:400;color:var(--text3);display:block">ថ្ងៃ</span></td>'
        +'<td style="text-align:center;font-weight:700;font-size:11px;color:'+(empOffDaysThisMonth>0?'#6366f1':'var(--text3)')+';width:'+(isMobile?30:34)+'px;max-width:'+(isMobile?30:34)+'px;overflow:hidden;padding:2px 1px;position:sticky;right:'+(isMobile?30:34)+'px;z-index:1;background:var(--bg2);border-left:1px solid var(--border)">'+(empOffDaysThisMonth>0?empOffDaysThisMonth:'—')+'</td>'
    ...
    contentArea().innerHTML =
      ...
      +'<tr style="position:sticky;top:0;z-index:4;background:var(--bg2);height:26px">'
          ...
          +dayThs
          +'<th style="width:'+(isMobile?30:34)+'px;text-align:center;padding:3px 1px;font-size:9px;color:var(--success);position:sticky;right:'+(isMobile?60:68)+'px;z-index:5;background:var(--bg2);box-shadow:-2px 0 4px rgba(0,0,0,.1)" rowspan="2" title="ធ្វើការ">📅<br/><span style="font-size:7px">ធ្វើ</span></th>'
          +'<th style="width:'+(isMobile?30:34)+'px;text-align:center;padding:3px 1px;font-size:8px;color:#6366f1;position:sticky;right:'+(isMobile?30:34)+'px;z-index:5;background:var(--bg2);border-left:1px solid var(--border);overflow:hidden;max-width:'+(isMobile?30:34)+'px" rowspan="2" title="📅 OFF ខែ"><span style="display:block;font-size:8px;font-weight:700;line-height:1.3">OFF</span><span style="display:block;font-size:7px;line-height:1.2;color:var(--text3)">ខែ</span></th>'
      ...
      +(()=>{
        ...
        return '<tfoot><tr style="position:sticky;bottom:0;z-index:3;background:var(--bg3);border-top:2px solid var(--border)">'
          ...
          +(()=>{
            ...
            return '<td style="background:var(--bg3);position:sticky;right:'+(isMobile?60:68)+'px;z-index:4;width:'+(isMobile?30:34)+'px;text-align:center;padding:2px 1px;border-left:1px solid var(--border)">'
              ...
              +'</td>'
              +'<td style="background:var(--bg3);position:sticky;right:'+(isMobile?30:34)+'px;z-index:4;width:'+(isMobile?30:34)+'px;text-align:center;padding:2px 1px;border-left:1px solid var(--border)">'
